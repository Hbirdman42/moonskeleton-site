    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
      ...
      <div className="space-y-6">
        ...
        <a
          ...
          className="inline-flex items-center justify-center w-full px-8 py-4 rounded-lg bg-accent-dim text-white text-lg font-bold hover:bg-accent transition-colors"
        >
          Buy Now
        </a>
